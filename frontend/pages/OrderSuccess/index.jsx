    ...
    return (
        <div>
            <Head>
                ...
                <meta name="description" content="Thanks for using Energy-Trade" />
            ...
            <main className={`${styles.main} flex flex-col items-center justify-start ml-[8.2%]`}>
                ...
                <div className={`${styles.container} z-20 flex flex-col items-center justify-start w-[90%] my-[60px]`}>
                    ...
                    {/* thanks text */}
                    <div className="font-barlow font-normal text-white text-[56px] leading-[42px] text-center mt-[75px]">Thanks for using Energy-Trade</div>
                    {/* transaction text */}
