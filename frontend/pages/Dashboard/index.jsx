    ...
    return (
        <div className={`${styles.main} flex items-start justify-between`}>
            ...
            <main className={`${styles.content} flex flex-col items-center justify-start ml-[8.2%]`}>
                ...
                {/* Thankyou text */}
                <div className="font-barlow font-medium text-white text-[36px] leading-[43px] text-center my-[60px] z-20">Thank you, for using Energy-Trade and saving the planet!</div>
