    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-start gap-10 mt-[30px] ml-[35px]">
                ...
                <div className={`${styles.fadeIn} ${isExpanded ? styles.active : ''} p-4 bg-gray-200 my-4  font-poppins font-normal font-medium text-32 leading-48 text-white`}>Energy-Trade</div>
            </div>
