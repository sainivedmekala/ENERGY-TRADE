    ...
    return (
        <div className="flex items-center justify-between w-full p-10">
            ...
            <Link href={`/`} className="flex items-center justify-center gap-6">
                ...
                <div className={"font-poppins font-normal font-medium text-32 leading-48 text-white"}>Energy-Trade</div>
            </Link>
                        ...
                        >
                            {(() => {
                                ...
                                if (!connected) {
                                    return (
                                        <button
                                            className="border-4 border-borderWalletBtn px-[40px] py-[5px] my-[120px] rounded-lg bg-transparent hover:bg-green-500 hover:text-white font-poppins font-bold text-[32px] leading-[48px] text-white text-center transition-colors duration-300"
